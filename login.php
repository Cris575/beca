...
<head>
    ...
    <link rel="stylesheet" href="../Nueva_carpeta/css/login.css">

</head>


<body class="text-center font2">
    <div class="container">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <main class="form-signin">
                    <form action="login.php" method="POST">
                        ...
                        <div class="form-floating">
                            <input type="password" class="form-control p" placeholder="name@example.com" name="password" required>
